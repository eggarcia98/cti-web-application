...
<div class="w-full inline-flex justify-center">
	<div
		class="mt-14 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700"
	>
			...
			<div class="mt-5">
				...
				<form method="post" use:enhance>
					<div class="grid gap-y-4">
						<!-- Form Group -->
						<div>
							<label for="user" class="block text-sm mb-2 dark:text-white">Username</label>
							<div class="relative">
								<input
									type="text"
									id="user"
